...
public class EthereumKeystoreV3: AbstractKeystore {
	...
	*/
    ...
    fileprivate func encryptDataToStorage(_ password: String, keyData: Data?, dkLen: Int = 32, N: Int = 131072, R: Int = 8, P: Int = 1, aesMode: String = "aes-128-cbc") throws {
        if keyData == nil {
    ...
    public func regenerate(oldPassword: String, newPassword: String, dkLen _: Int = 32, N _: Int = 131072, R _: Int = 8, P _: Int = 1) throws {
